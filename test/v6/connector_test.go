...
func TestOperationsWithSmallestBulkSize(t *testing.T) {
	...
	cfgRaw := map[string]string{
		destination.ConfigKeyVersion:  elasticsearch.Version6,
...
func assertIndexContainsDocuments(t *testing.T, esClient *esV6.Client, documents []map[string]interface{}) error {
